...
const styleExtract = new MiniCssExtractPlugin({
    filename:
        process.env.NODE_ENV === "production"
            ? "../css/[name].min.css"
            : "../css/[name].css",
});
const mainMinStyle = new OptimizeCssAssetsPlugin({
    assetNameRegExp: /main\.min\.css$/,
});
const inlineMinStyle = new OptimizeCssAssetsPlugin({
    assetNameRegExp: /inline\.min\.css$/,
});
